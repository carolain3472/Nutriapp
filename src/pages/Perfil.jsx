...
export function Perfil() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      setPhotoPreview(
        user.fotoUrl ? `http://localhost:5000${user.fotoUrl}` : ""
      );
    }
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://nutriapp-0agf.onrender.com/api/auth/update-profile",
        {
          method: "POST",
          body: formData,
        }
      ...
      const updatedPhotoUrl = updated.photoUrl
        ? `https://nutriapp-0agf.onrender.com${updated.photoUrl}`
        : userData.photoUrl;
      ...
      const updatedUser = {
        ...
        fotoUrl: updated.photoUrl || storedUser.fotoUrl,
      };
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Ocurrió un error al guardar los cambios. Intenta nuevamente más tarde.",
      });
    } finally {
      setIsSaving(false);
    }
